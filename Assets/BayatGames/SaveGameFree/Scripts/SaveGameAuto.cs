...
namespace BayatGames.SaveGameFree
{
    ...
    public class SaveGameAuto : MonoBehaviour
    {
        ...
        [Header("Defaults")] [Space] [Tooltip("Default Position Value")]
        /// <summary>
        ...
        [Header("Load Events")] [Space] [Tooltip("Load on Awake()")]
        /// <summary>
        /// The load on awake.
        /// </summary>
        ...
        [Header("Settings")] [Space] [Tooltip("You must specify a value for this to be able to save it.")]
        /// <summary>
        ...
        [Header("Save Events")] [Space] [Tooltip("Save on Awake()")]
        /// <summary>
        /// The save on awake.
        /// </summary>
        ...
        [Header("What to Save?")] [Space] [Tooltip("Save Position?")]
        /// <summary>
        /// The save position.
        /// </summary>
        ...
        protected virtual void Awake()
        {
            if (resetBlanks)
            {
                if (string.IsNullOrEmpty(encodePassword)) encodePassword = SaveGame.EncodePassword;
                if (serializer == null) serializer = SaveGame.Serializer;
                if (encoder == null) encoder = SaveGame.Encoder;
        ...
        {
            if (saveOnApplicationPause) Save();
        }
